...
this.y=Math.random()*pJS.canvas.h;if(pJS.retina){if(pJS.particles.size_random){this.radius=(Math.random()+1.5)*2;}else{this.radius=pJS.particles.size*2;
}}else{if(pJS.particles.size_random){this.radius=Math.random()+1.5;}else{this.radius=pJS.particles.size*1;}}this.color=e;this.opacity=f;
...
}e.onmousemove=function(f){if(pJS.retina){pJS.interactivity.mouse.pos_x=f.pageX*2;pJS.interactivity.mouse.pos_y=(f.pageY*2)-300;}else{pJS.interactivity.mouse.pos_x=f.pageX;
pJS.interactivity.mouse.pos_y=f.pageY-300;}pJS.interactivity.status="mousemove";};e.onmouseleave=function(f){pJS.interactivity.mouse.pos_x=0;pJS.interactivity.mouse.pos_y=0;
...
}if(!d){d="particles-js";}var b=document.createElement("canvas");b.style.width="75%";b.style.height=document.getElementById("part").offsetHeight+'px';var a=document.getElementById(d).appendChild(b);
