...
}if(!d){d="particles-js";}var b=document.createElement("canvas");if(skel.isActive('1000px')){b.style.width="100%"}else{b.style.width="75%"};b.style.height='300px';var a=document.getElementById(d).appendChild(b);
